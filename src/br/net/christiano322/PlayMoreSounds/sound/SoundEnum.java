...
public enum SoundEnum {
    ...
    BLOCK_ANVIL_PLACE("BLOCK_ANVIL_PLACE", "ANVIL_LAND"),
    ...
    BLOCK_ENDER_CHEST_OPEN("BLOCK_ENDER_CHEST_OPEN", "BLOCK_ENDERCHEST_OPEN"),
    ...
    BLOCK_LILY_PAD_PLACE("BLOCK_LILY_PAD_PLACE", "BLOCK_WATERLILY_PLACE"),
    ...
    BLOCK_METAL_PRESSURE_PLATE_CLICK_OFF("BLOCK_METAL_PRESSURE_PLATE_CLICK_OFF", "BLOCK_METAL_PRESSUREPLATE_CLICK_OFF"),
    BLOCK_METAL_PRESSURE_PLATE_CLICK_ON("BLOCK_METAL_PRESSURE_PLATE_CLICK_ON", "BLOCK_METAL_PRESSUREPLATE_CLICK_ON"),
    BLOCK_METAL_STEP("BLOCK_METAL_STEP"),
    BLOCK_NOTE_BLOCK_BASEDRUM("BLOCK_NOTE_BLOCK_BASEDRUM", "BLOCK_NOTE_BASEDRUM", "NOTE_BASS_DRUM"),
    BLOCK_NOTE_BLOCK_BASS("BLOCK_NOTE_BLOCK_BASS", "BLOCK_NOTE_BASS", "NOTE_BASS"),
    BLOCK_NOTE_BLOCK_BELL("BLOCK_NOTE_BLOCK_BELL", "BLOCK_NOTE_BELL"),
    BLOCK_NOTE_BLOCK_CHIME("BLOCK_NOTE_BLOCK_CHIME", "BLOCK_NOTE_CHIME"),
    BLOCK_NOTE_BLOCK_FLUTE("BLOCK_NOTE_BLOCK_FLUTE", "BLOCK_NOTE_FLUTE"),
    BLOCK_NOTE_BLOCK_GUITAR("BLOCK_NOTE_BLOCK_GUITAR", "BLOCK_NOTE_GUITAR", "BLOCK_NOTE_BASS", "NOTE_BASS_GUITAR"),
    BLOCK_NOTE_BLOCK_HARP("BLOCK_NOTE_BLOCK_HARP", "BLOCK_NOTE_HARP", "NOTE_PIANO"),
    BLOCK_NOTE_BLOCK_HAT("BLOCK_NOTE_BLOCK_HAT", "BLOCK_NOTE_HAT", "NOTE_STICKS"),
    BLOCK_NOTE_BLOCK_PLING("BLOCK_NOTE_BLOCK_PLING", "BLOCK_NOTE_PLING", "NOTE_PLING"),
    BLOCK_NOTE_BLOCK_SNARE("BLOCK_NOTE_BLOCK_SNARE", "BLOCK_NOTE_SNARE", "NOTE_SNARE_DRUM"),
    BLOCK_NOTE_BLOCK_XYLOPHONE("BLOCK_NOTE_BLOCK_XYLOPHONE", "BLOCK_NOTE_XYLOPHONE"),
    ...
    BLOCK_SLIME_BLOCK_BREAK("BLOCK_SLIME_BLOCK_BREAK", "BLOCK_SLIME_BREAK"),
    BLOCK_SLIME_BLOCK_FALL("BLOCK_SLIME_BLOCK_FALL", "BLOCK_SLIME_FALL"),
    BLOCK_SLIME_BLOCK_HIT("BLOCK_SLIME_BLOCK_HIT", "BLOCK_SLIME_HIT"),
    BLOCK_SLIME_BLOCK_PLACE("BLOCK_SLIME_BLOCK_PLACE", "BLOCK_SLIME_PLACE"),
    BLOCK_SLIME_BLOCK_STEP("BLOCK_SLIME_BLOCK_STEP", "BLOCK_SLIME_STEP"),
    ...
    BLOCK_STONE_PRESSURE_PLATE_CLICK_OFF("BLOCK_STONE_PRESSURE_PLATE_CLICK_OFF", "BLOCK_STONE_PRESSUREPLATE_CLICK_OFF"),
    BLOCK_STONE_PRESSURE_PLATE_CLICK_ON("BLOCK_STONE_PRESSURE_PLATE_CLICK_ON", "BLOCK_STONE_PRESSUREPLATE_CLICK_ON"),
    ...
    BLOCK_WOODEN_BUTTON_CLICK_OFF("BLOCK_WOODEN_BUTTON_CLICK_OFF", "BLOCK_WOOD_BUTTON_CLICK_OFF"),
    BLOCK_WOODEN_BUTTON_CLICK_ON("BLOCK_WOODEN_BUTTON_CLICK_ON", "BLOCK_WOOD_BUTTON_CLICK_OFF", "WOOD_CLICK"),
    BLOCK_WOODEN_DOOR_CLOSE("BLOCK_WOODEN_DOOR_CLOSE", "DOOR_CLOSE"),
    BLOCK_WOODEN_DOOR_OPEN("BLOCK_WOODEN_DOOR_OPEN", "DOOR_OPEN"),
    BLOCK_WOODEN_PRESSURE_PLATE_CLICK_OFF("BLOCK_WOODEN_PRESSURE_PLATE_CLICK_OFF", "BLOCK_WOOD_PRESSUREPLATE_CLICK_OFF"),
    BLOCK_WOODEN_PRESSURE_PLATE_CLICK_ON("BLOCK_WOODEN_PRESSURE_PLATE_CLICK_ON", "BLOCK_WOOD_PRESSUREPLATE_CLICK_ON"),
    ...
    BLOCK_WOOL_BREAK("BLOCK_WOOL_BREAK", "BLOCK_CLOTH_BREAK", "DIG_WOOL"),
    BLOCK_WOOL_FALL("BLOCK_WOOL_FALL", "BLOCK_CLOTH_FALL"),
    BLOCK_WOOL_HIT("BLOCK_WOOL_HIT", "BLOCK_CLOTH_HIT"),
    BLOCK_WOOL_PLACE("BLOCK_WOOL_PLACE", "BLOCK_CLOTH_PLACE"),
    BLOCK_WOOL_STEP("BLOCK_WOOL_STEP", "BLOCK_CLOTH_STEP", "STEP_WOOL"),
    ENCHANT_THORNS_HIT("ENCHANT_THORNS_HIT"),
    ENTITY_ARMOR_STAND_BREAK("ENTITY_ARMOR_STAND_BREAK", "ENTITY_ARMORSTAND_BREAK"),
    ENTITY_ARMOR_STAND_FALL("ENTITY_ARMOR_STAND_FALL", "ENTITY_ARMORSTAND_FALL"),
    ENTITY_ARMOR_STAND_HIT("ENTITY_ARMOR_STAND_HIT", "ENTITY_ARMORSTAND_HIT"),
    ENTITY_ARMOR_STAND_PLACE("ENTITY_ARMOR_STAND_PLACE", "ENTITY_ARMORSTAND_PLACE"),
    ...
    ENTITY_CREEPER_PRIMED("ENTITY_CREEPER_PRIMED", "CREEPER_HISS"),
    ...
    ENTITY_DONKEY_ANGRY("ENTITY_DONKEY_ANGRY", "DONKEY_AGRY"),
    ...
    ENTITY_DRAGON_FIREBALL_EXPLODE("ENTITY_DRAGON_FIREBALL_EXPLODE", "ENTITY_ENDERDRAGON_FIREBALL_EXPLODE"),
    ...
    ENTITY_EGG_THROW("ENTITY_EGG_THROW", "SHOOT_ARROW"),
    ...
    ENTITY_ENDERMAN_AMBIENT("ENTITY_ENDERMAN_AMBIENT", "ENTITY_ENDERMEN_AMBIENT", "ENDERMAN_AMBIENT"),
    ENTITY_ENDERMAN_DEATH("ENTITY_ENDERMAN_DEATH", "ENTITY_ENDERMEN_DEATH", "ENDERMAN_DEATH"),
    ENTITY_ENDERMAN_HURT("ENTITY_ENDERMAN_HURT", "ENTITY_ENDERMEN_HURT", "ENDERMAN_HIT"),
    ENTITY_ENDERMAN_SCREAM("ENTITY_ENDERMAN_SCREAM", "ENTITY_ENDERMEN_SCREAM", "ENDERMAN_SCREAM"),
    ENTITY_ENDERMAN_STARE("ENTITY_ENDERMAN_STARE", "ENTITY_ENDERMEN_STARE", "ENDERMAN_STARE"),
    ENTITY_ENDERMAN_TELEPORT("ENTITY_ENDERMAN_TELEPORT", "ENTITY_ENDERMEN_TELEPORT", "ENDERMAN_TELEPORT"),
    ...
    ENTITY_ENDER_DRAGON_AMBIENT("ENTITY_ENDER_DRAGON_AMBIENT", "ENTITY_ENDERDRAGON_AMBIENT"),
    ENTITY_ENDER_DRAGON_DEATH("ENTITY_ENDER_DRAGON_DEATH", "ENTITY_ENDERDRAGON_DEATH", "ENDERDRAGON_DEATH"),
    ENTITY_ENDER_DRAGON_FLAP("ENTITY_ENDER_DRAGON_FLAP", "ENTITY_ENDERDRAGON_FLAP", "ENDERDRAGON_WINGS"),
    ENTITY_ENDER_DRAGON_GROWL("ENTITY_ENDER_DRAGON_GROWL", "ENTITY_ENDERDRAGON_GROWL", "ENDERDRAGON_GROWL"),
    ENTITY_ENDER_DRAGON_HURT("ENTITY_ENDER_DRAGON_HURT", "ENTITY_ENDERDRAGON_HURT", "ENDERDRAGON_HIT"),
    ENTITY_ENDER_DRAGON_SHOOT("ENTITY_ENDER_DRAGON_SHOOT", "ENTITY_ENDERDRAGON_SHOOT"),
    ENTITY_ENDER_EYE_DEATH("ENTITY_ENDER_EYE_DEATH", "ENTITY_ENDEREYE_DEATH"),
    ENTITY_ENDER_EYE_LAUNCH("ENTITY_ENDER_EYE_LAUNCH", "ENTITY_ENDEREYE_LAUNCH"),
    ...
    ENTITY_EVOKER_FANGS_ATTACK("ENTITY_EVOKER_FANGS_ATTACK", "ENTITY_EVOCATION_FANGS_ATTACK"),
    ...
    ENTITY_FIREWORK_ROCKET_BLAST("ENTITY_FIREWORK_ROCKET_BLAST", "ENTITY_FIREWORK_BLAST", "FIREWORK_BLAST"),
    ENTITY_FIREWORK_ROCKET_BLAST_FAR("ENTITY_FIREWORK_ROCKET_BLAST_FAR", "ENTITY_FIREWORK_BLAST_FAR", "FIREWORK_BLAST2"),
    ENTITY_FIREWORK_ROCKET_LARGE_BLAST("ENTITY_FIREWORK_ROCKET_LARGE_BLAST", "ENTITY_FIREWORK_LARGE_BLAST", "FIREWORK_LARGE_BLAST"),
    ENTITY_FIREWORK_ROCKET_LARGE_BLAST_FAR("ENTITY_FIREWORK_ROCKET_LARGE_BLAST_FAR", "ENTITY_FIREWORK_LARGE_BLAST_FAR", "FIREWORK_LARGE_BLAST2"),
    ENTITY_FIREWORK_ROCKET_LAUNCH("ENTITY_FIREWORK_ROCKET_LAUNCH", "ENTITY_FIREWORK_LAUNCH", "FIREWORK_LAUNCH"),
    ENTITY_FIREWORK_ROCKET_SHOOT("ENTITY_FIREWORK_ROCKET_SHOOT", "ENTITY_FIREWORK_SHOOT"),
    ENTITY_FIREWORK_ROCKET_TWINKLE("ENTITY_FIREWORK_ROCKET_TWINKLE", "ENTITY_FIREWORK_TWINKLE", "FIREWORK_TWINKLE"),
    ENTITY_FIREWORK_ROCKET_TWINKLE_FAR("ENTITY_FIREWORK_ROCKET_TWINKLE_FAR", "ENTITY_FIREWORK_TWINKLE_FAR", "FIREWORK_TWINKLE2"),
    ENTITY_FISHING_BOBBER_RETRIEVE("ENTITY_FISHING_BOBBER_RETRIEVE", "ENTITY_BOBBER_RETRIEVE"),
    ENTITY_FISHING_BOBBER_SPLASH("ENTITY_FISHING_BOBBER_SPLASH", "ENTITY_BOBBER_SPLASH", "SPLASH2"),
    ...
    ENTITY_GENERIC_EXTINGUISH_FIRE("ENTITY_GENERIC_EXTINGUISH_FIRE", "FIZZ"),
    ...
    ENTITY_GHAST_HURT("ENTITY_GHAST_HURT", "GHAST_SCREAM2"),
    ...
    ENTITY_ILLUSIONER_DEATH("ENTITY_ILLUSIONER_DEATH", "ENTITY_ILLUSION_ILLAGER_DEATH"),
    ...
    ENTITY_IRON_GOLEM_ATTACK("ENTITY_IRON_GOLEM_ATTACK", "ENTITY_IRONGOLEM_ATTACK", "IRONGOLEM_THROW"),
    ENTITY_IRON_GOLEM_DEATH("ENTITY_IRON_GOLEM_DEATH", "ENTITY_IRONGOLEM_DEATH", "IRONGOLEM_DEATH"),
    ENTITY_IRON_GOLEM_HURT("ENTITY_IRON_GOLEM_HURT", "ENTITY_IRONGOLEM_HURT", "IRONGOLEM_HIT"),
    ENTITY_IRON_GOLEM_STEP("ENTITY_IRON_GOLEM_STEP", "ENTITY_IRONGOLEM_STEP", "IRONGOLEM_WALK"),
    ...
    ENTITY_LIGHTNING_BOLT_IMPACT("ENTITY_LIGHTNING_BOLT_IMPACT", "ENTITY_LIGHTNING_IMPACT"),
    ENTITY_LIGHTNING_BOLT_THUNDER("ENTITY_LIGHTNING_BOLT_THUNDER", "ENTITY_LIGHTNING_THUNDER", "AMBIENCE_THUNDER"),
    ENTITY_LINGERING_POTION_THROW("ENTITY_LINGERING_POTION_THROW", "ENTITY_LINGERINGPOTION_THROW"),
    ...
    ENTITY_MAGMA_CUBE_JUMP("ENTITY_MAGMA_CUBE_JUMP", "ENTITY_MAGMACUBE_JUMP", "MAGMACUBE_JUMP"),
    ENTITY_MAGMA_CUBE_SQUISH("ENTITY_MAGMA_CUBE_SQUISH", "ENTITY_MAGMACUBE_SQUISH", "MAGMACUBE_WALK"),
    ENTITY_MAGMA_CUBE_SQUISH_SMALL("ENTITY_MAGMA_CUBE_SQUISH_SMALL", "ENTITY_SMALL_MAGMACUBE_SQUISH", "MAGMACUBE_WALK2"),
    ...
    ENTITY_PARROT_IMITATE_ENDER_DRAGON("ENTITY_PARROT_IMITATE_ENDER_DRAGON", "ENTITY_PARROT_IMITATE_ENDERDRAGON"),
    ENTITY_PARROT_IMITATE_EVOKER("ENTITY_PARROT_IMITATE_EVOKER", "ENTITY_PARROT_IMITATE_EVOCATION_ILLAGER"),
    ENTITY_PARROT_IMITATE_GHAST("ENTITY_PARROT_IMITATE_GHAST"),
    ENTITY_PARROT_IMITATE_HUSK("ENTITY_PARROT_IMITATE_HUSK"),
    ENTITY_PARROT_IMITATE_ILLUSIONER("ENTITY_PARROT_IMITATE_ILLUSIONER", "ENTITY_PARROT_IMITATE_ILLUSION_ILLAGER"),
    ENTITY_PARROT_IMITATE_MAGMA_CUBE("ENTITY_PARROT_IMITATE_MAGMA_CUBE", "ENTITY_PARROT_IMITATE_MAGMACUBE"),
    ...
    ENTITY_PARROT_IMITATE_VINDICATOR("ENTITY_PARROT_IMITATE_VINDICATOR", "ENTITY_PARROT_IMITATE_VINDICATION_ILLAGER"),
    ...
    ENTITY_PLAYER_ATTACK_STRONG("ENTITY_PLAYER_ATTACK_STRONG", "SUCCESSFUL_HIT"),
    ...
    ENTITY_POLAR_BEAR_AMBIENT_BABY("ENTITY_POLAR_BEAR_AMBIENT_BABY", "ENTITY_POLAR_BEAR_BABY_AMBIENT"),
    ...
    ENTITY_SKELETON_DEATH("ENTITY_SKELETON_DEATH", "SKELETOM_DEATH"),
    ...
    ENTITY_SLIME_DEATH_SMALL("ENTITY_SLIME_DEATH_SMALL", "ENTITY_SMALL_SLIME_DEATH"),
    ENTITY_SLIME_HURT("ENTITY_SLIME_HURT"),
    ENTITY_SLIME_HURT_SMALL("ENTITY_SLIME_HURT_SMALL", "ENTITY_SMALL_SLIME_HURT"),
    ENTITY_SLIME_JUMP("ENTITY_SLIME_JUMP"),
    ENTITY_SLIME_JUMP_SMALL("ENTITY_SLIME_JUMP_SMALL", "ENTITY_SMALL_SLIME_JUMP"),
    ENTITY_SLIME_SQUISH("ENTITY_SLIME_SQUISH", "SLIME_WALK"),
    ENTITY_SLIME_SQUISH_SMALL("ENTITY_SLIME_SQUISH_SMALL", "ENTITY_SMALL_SLIME_SQUISH", "SLIME_WALK2"),
    ...
    ENTITY_SNOW_GOLEM_HURT("ENTITY_SNOW_GOLEM_HURT", "ENTITY_SNOWMAM_HURT"),
    ...
    ENTITY_VILLAGER_TRADE("ENTITY_VILLAGER_TRADE", "ENTITY_VILLAGER_TRADING", "VILLAGER_HAGGLE"),
    ENTITY_VILLAGER_YES("ENTITY_VILLAGER_YES", "VILLAGER_YES"),
    ENTITY_VINDICATOR_AMBIENT("ENTITY_VINDICATOR_AMBIENT", "ENTITY_VINDICATION_ILLAGER_AMBIENT"),
    ENTITY_VINDICATOR_DEATH("ENTITY_VINDICATOR_DEATH", "ENTITY_VINDICATION_ILLAGER_DEATH"),
    ENTITY_VINDICATOR_HURT("ENTITY_VINDICATOR_HURT", "ENTITY_VINDICATION_ILLAGER_HURT"),
    ...
    ENTITY_ZOMBIE_ATTACK_WOODEN_DOOR("ENTITY_ZOMBIE_ATTACK_WOODEN_DOOR", "ENTITY_ZOMBIE_ATTACK_DOOR_WOOD", "ZOMBIE_WOOD"),
    ENTITY_ZOMBIE_BREAK_WOODEN_DOOR("ENTITY_ZOMBIE_BREAK_WOODEN_DOOR", "ENTITY_ZOMBIE_BREAK_DOOR_WOOD", "ZOMBIE_WOODBREAK"),
    ...
    ENTITY_ZOMBIE_PIGMAN_AMBIENT("ENTITY_ZOMBIE_PIGMAN_AMBIENT", "ENTITY_ZOMBIE_PIG_AMBIENT", "ZOMBIE_PIG_IDLE"),
    ENTITY_ZOMBIE_PIGMAN_ANGRY("ENTITY_ZOMBIE_PIGMAN_ANGRY", "ENTITY_ZOMBIE_PIG_ANGRY", "ZOMBIE_PIG_ANGRY"),
    ENTITY_ZOMBIE_PIGMAN_DEATH("ENTITY_ZOMBIE_PIGMAN_DEATH", "ENTITY_ZOMBIE_PIG_DEATH", "ZOMBIE_PIG_DEATH"),
    ENTITY_ZOMBIE_PIGMAN_HURT("ENTITY_ZOMBIE_PIGMAN_HURT", "ENTITY_ZOMBIE_PIG_HURT", "ZOMBIE_PIG_HURT"),
